...
var ChildComponent = /** @class */ (function () {
    ...
    ChildComponent.prototype.handleData = function (event) {
        var _this = this;
        this.message = event;
        setTimeout(function () {
            _this.passDataToParent.emit(event);
            _this.upstream = true;
        }, 1000);
    };
...
var GrandChildComponent = /** @class */ (function () {
    ...
    GrandChildComponent.prototype.handleData = function (event) {
        var _this = this;
        this.message = event;
        setTimeout(function () { _this.passDataToChild.emit(event); _this.upstream = true; }, 1000);
    };
    GrandChildComponent.prototype.ngOnChanges = function (changes) {
        if (changes['messageFromParent']) {
            this.upstream = false;
        }
        ;
...
var GrandparentComponent = /** @class */ (function () {
    function GrandparentComponent() {
        this.passDataToGreatGrandParent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    GrandparentComponent.prototype.ngOnInit = function () { };
    GrandparentComponent.prototype.handleData = function (event) {
        var _this = this;
        this.message = event;
        setTimeout(function () {
            _this.passDataToGreatGrandParent.emit(event);
            _this.upstream = true;
        }, 1000);
    };
    GrandparentComponent.prototype.ngOnChanges = function (changes) {
        if (changes['messageFromParent']) {
            this.upstream = false;
        }
        ;
...
var GreatGrandchildComponent = /** @class */ (function () {
    function GreatGrandchildComponent() {
        this.passDataToGrandchild = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.message = "";
        this.isClicked = false;
    }
    GreatGrandchildComponent.prototype.ngOnInit = function () { };
    GreatGrandchildComponent.prototype.handleClick = function (event) {
        var _this = this;
        setTimeout(function () {
            _this.passDataToGrandchild.emit(_this.message);
            _this.upstream = true;
            _this.isClicked = true;
        }, 1000);
    };
    GreatGrandchildComponent.prototype.ngOnChanges = function (changes) {
        if (changes['messageFromParent']) {
            this.upstream = false;
        }
        ;
    ...
    return GreatGrandchildComponent;
}());
...
var GreatGrandparentComponent = /** @class */ (function () {
    function GreatGrandparentComponent() {
        this.isSendMessageDownButtonClicked = false;
    }
    GreatGrandparentComponent.prototype.ngOnInit = function () {
    };
    GreatGrandparentComponent.prototype.handleData = function (event) {
        this.message = event;
        this.upstream = true;
    };
    GreatGrandparentComponent.prototype.handleClick = function (event) {
        var _this = this;
        this.isSendMessageDownButtonClicked = true;
        this.upstream = false;
        setTimeout(function () {
            _this.downstreamMessage = _this.downstreamMessageGreatGrandparent;
        }, 1000);
    };
    ...
    return GreatGrandparentComponent;
}());
...
var ParentComponent = /** @class */ (function () {
    ...
    ParentComponent.prototype.handleData = function (event) {
        var _this = this;
        this.message = event;
        setTimeout(function () { _this.passDataToGrandParent.emit(event); _this.upstream = true; }, 1000);
    };
